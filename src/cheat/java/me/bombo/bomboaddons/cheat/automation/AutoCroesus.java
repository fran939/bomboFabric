package me.bombo.bomboaddons.cheat.automation;
...
public class AutoCroesus {
   ...
   public static void handleDungeonRunTick(AbstractContainerScreen<?> screen, BomboConfig.Settings s) {
      ...
      me.bombo.bomboaddons.cheat.dungeons.DungeonChestProfitHud.currentChests = chests;
      ...
      if (s.autoCroesus && active && now - lastActionTime > s.autoCroesusDelay) {
         ...
         me.bombo.bomboaddons.cheat.dungeons.KismetEv.refreshIfStale(playerIgn);
         boolean haveEv = me.bombo.bomboaddons.cheat.dungeons.KismetEv.peek() != null;
         long kismetThreshold = haveEv
                 ? me.bombo.bomboaddons.cheat.dungeons.KismetEv.getRerollSpotThreshold(playerIgn, 0)
                 : s.kismetThreshold;
   ...
   public static void recordChestPurchase(long profit, boolean usedKismet, List<ItemDetail> items, String floor) {
      ...
      me.bombo.bomboaddons.cheat.dungeons.CroesusProfitTrackerHud.markDirty();
   }
