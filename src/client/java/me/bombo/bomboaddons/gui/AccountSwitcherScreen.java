...
public class AccountSwitcherScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addRenderableWidget(Button.builder(Component.literal("Back"), (button) -> Minecraft.getInstance().setScreenAndShow(this.parent)).bounds(this.width / 2 - 100, this.height - 30, 200, 20).build());
      int count = 0;
