...
public class CustomListEditorScreen extends Screen {
   ...
   protected void init() {
      ...
      this.btnBack = Button.builder(Component.literal("Back to MoulConfig"), (btn) -> Minecraft.getInstance().setScreenAndShow(this.parentScreen)).bounds(cardX + cardW - 144, btnY, 130, 18).build();
