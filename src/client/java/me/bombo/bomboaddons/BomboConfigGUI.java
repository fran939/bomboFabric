...
public class BomboConfigGUI
    ...
    private final List<String> categories = List.of("General", "HUDs", "Experiments", "Garden", "Hotkeys", "Profiles",
            ...
            "Item Highlights", "Ordered Waypoints", "Timers", "Widgets", "Chat Modifier");
            ...
            switch (selectedCategory) {
                case 0: {
                    ...
                    if (loreAdditionsSubmenu) {
                        ...
                        y1 += 28;
                        y1 = this.addLoreOptionWithOrder("Copy Canceled Order Amount (Ctrl+Click)", "copyCanceled",
                                s.copyCanceledOrderAmount, v -> s.copyCanceledOrderAmount = v, 1, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Supercraft Max Calculator (Ctrl+Click)", "supercraft",
                                s.supercraftMaxCalculator, v -> s.supercraftMaxCalculator = v, 2, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Starts In Absolute Time", "startsIn", s.startsInAbsoluteTime,
                                v -> s.startsInAbsoluteTime = v, 3, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Dungeon Item Quality", "dungeonQuality", s.showDungeonQuality,
                                v -> s.showDungeonQuality = v, 4, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Item Creation Date", "itemCreationDate",
                                s.showItemCreationDate, v -> s.showItemCreationDate = v, 5, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Leather Armor Hex Color", "leatherColor", s.showLeatherColor,
                                v -> s.showLeatherColor = v, 6, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Museum Donated Status", "museumDonated", s.showMuseumDonated,
                                v -> s.showMuseumDonated = v, 7, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Skyblock Item ID", "skyblockId", s.showSkyblockId,
                                v -> s.showSkyblockId = v, 8, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Lowest BIN / BZ Price", "lowestBin", s.lowestBin,
                                v -> s.lowestBin = v, 9, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Raw Craft Cost", "craftCost", s.craftCostTooltip,
                                v -> s.craftCostTooltip = v, 10, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("NPC Sell Price", "npcPrice", s.npcPrice, v -> s.npcPrice = v,
                                11, col1X, col1W * 2, y1);
                        y1 = this.addLoreOptionWithOrder("Pet Lowest BIN", "petLowestBin", s.showPetLowestBin,
                                v -> s.showPetLowestBin = v, 12, col1X, col1W * 2, y1);
                        break;
                    }
                    ...
                    y1 = this.addBoolOption("In-Chat Search Bar", s.chatSearchBar, v -> s.chatSearchBar = v, col1X,
                            col1W, y1);
                    if (s.chatSearchBar) {
                    ...
                    y1 = this.addBoolOption("Egg Finder Chat Alerts", s.eggFinderChat, v -> s.eggFinderChat = v, col1X,
                            col1W, y1);
                    y1 = this.addBoolOption("Egg Finder Beacon", s.eggFinderBeacon, v -> s.eggFinderBeacon = v, col1X,
                            col1W, y1);
                    y1 = this.addBoolOption("Egg Finder Through Walls", s.eggFinderThroughWalls,
                    ...
                    y1 = this.addBoolOption("Golden Dragon Nest Finder", s.goldenDragonNestFinder,
                            v -> s.goldenDragonNestFinder = v, col1X, col1W, y1);
                    ...
                    y2 = this.addBoolOption("Borderless Fullscreen", s.borderlessFullscreen, v -> {
                        ...
                        BomboConfig.save();
                        try {
                            ((WindowAccessor) (Object) Minecraft.getInstance().getWindow()).invokeUpdateFullscreen(
                                    (Boolean) Minecraft.getInstance().options.enableVsync().get());
                ...
                case 1: {
                    ...
                    int col2W = contentWidth / 2 - 10;
                    int y1 = contentBaseY + 24 - (int) this.scrollAmount;
                    y1 = this.addBoolOption("Dice Tracker HUD", s.diceTracker, v -> s.diceTracker = v, col1X, col1W,
                            y1);
                    y1 = this.addBoolOption("Feast Bakery HUD", s.feastBakeryHud, v -> s.feastBakeryHud = v, col1X,
                            col1W, y1);
                    y1 = this.addBoolOption("RNG Profit HUD", s.rngProfitHud, v -> s.rngProfitHud = v, col1X, col1W,
                            y1);
                    y1 = this.addIntLabelSlider("RNG HUD Opacity", s.rngProfitHudOpacity, 0, 100, 10,
                            v -> s.rngProfitHudOpacity = v, col1X, col1W, y1);
                    y1 = this.addBoolOption("Custom Timers HUD", s.customTimerHudEnabled,
                            v -> s.customTimerHudEnabled = v, col1X, col1W, y1);
                    y1 = this.addBoolOption("Tab Widget HUD", s.tabWidgetHudEnabled, v -> s.tabWidgetHudEnabled = v,
                            col1X, col1W, y1);
                    y1 = this.addBoolOption("Hoppity Egg HUD", s.hoppityHud, v -> s.hoppityHud = v, col1X, col1W, y1);
                    this.addRenderableWidget(Button
                            .builder(Component.literal("Move HUD Elements"),
                                    b -> Minecraft.getInstance().setScreenAndShow(new HudMoveScreen()))
                            .bounds(col1X, y1, col1W, 20).build());
                    y1 += 26;
                    y1 = this.addBoolOption("Alpha Tracker HUD", s.alphaTrackerHud, v -> s.alphaTrackerHud = v, col1X,
                            col1W, y1);
                    ...
                    y1 = this.addBoolOption("Item List Enabled", s.itemListEnabled, v -> s.itemListEnabled = v, col1X,
                            col1W, y1);
                    ...
                    if (generalHeaderY > listStartY + 5 && generalHeaderY < this.height - 20) {
                        ...
                        this.addRenderableWidget(Button.builder(
                                ...
                                btn -> {
                                    ...
                                    BomboConfig.save();
                                    this.init();
                                }).bounds(contentX + contentWidth - 145, generalHeaderY + 2, 38, 18).build());
                        ...
                        this.addRenderableWidget(Button.builder((Component) Component.literal("\u00a7aALL"), btn -> {
                            ...
                            BomboConfig.save();
                            this.init();
                        }).bounds(contentX + contentWidth - 102, generalHeaderY + 2, 38, 18).build());
                        ...
                        this.addRenderableWidget(Button.builder((Component) Component.literal("\u00a7cDEL"), btn -> {
                            ...
                            BomboConfig.save();
                            this.init();
                        }).bounds(contentX + contentWidth - 25, generalHeaderY + 2, 25, 18).build());
                    }
                    ...
                    if (bestiaryHeaderY > listStartY + 5 && bestiaryHeaderY < this.height - 20) {
                        ...
                        this.addRenderableWidget(Button.builder(
                                ...
                                btn -> {
                                    ...
                                    this.init();
                                }).bounds(contentX + contentWidth - 145, bestiaryHeaderY + 2, 38, 18).build());
                            ...
                            if (headerY > listStartY + 5 && headerY < this.height - 20) {
                                ...
                                this.addRenderableWidget(Button.builder(
                                        ...
                                        btn -> {
                                            me.bombo.bomboaddons.features.BestiaryManager.setCategoryTracer(cat,
                                                    !catTracer);
                                            this.init();
                                        }).bounds(contentX + contentWidth - 145, headerY + 2, 38, 18).build());
                                ...
                                this.addRenderableWidget(
                                        Button.builder((Component) Component.literal("\u00a7aALL"), btn -> {
                                            ...
                                            BomboConfig.save();
                                            this.init();
                                        }).bounds(contentX + contentWidth - 102, headerY + 2, 38, 18).build());
                                ...
                                this.addRenderableWidget(
                                        Button.builder((Component) Component.literal("\u00a7cDEL"), btn -> {
                                            ...
                                            BomboConfig.save();
                                            this.init();
                                        }).bounds(contentX + contentWidth - 25, headerY + 2, 25, 18).build());
                            }
                                    ...
                                    this.addRenderableWidget(
                                            Button.builder(
                                                    ...
                                                    btn -> {
                                                        ...
                                                        this.init();
                                                    }).bounds(contentX + contentWidth - 210, itemY + 2, 60, 18)
                                                    .build());
                                ...
                                try {
                                    ...
                                    if (!id.isEmpty()) {
                                        s.customTracers.put(id,
                                                new BomboConfig.Settings.CustomTracerInfo(newTracerNameInput, "GREEN"));
                                        newTracerIdInput = "";
                                        newTracerNameInput = "";
                                        BomboConfig.save();
                                        this.init();
                        ...
                        this.addRenderableWidget(Button
                                .builder((Component) Component.literal((String) "\u00a7e\u2714 Save Tracer"), btn -> {
                                    if (s.customTracers.containsKey(editingCustomTracer)) {
                                        BomboConfig.Settings.CustomTracerInfo info = s.customTracers
    ...
    private int addLoreOptionWithOrder(String label, String key, boolean value, Consumer<Boolean> setter,
            int defaultOrder, int x, int w, int y) {
        if (!optionMatchesSearch(label))
            return y;
        BomboConfig.Settings s = BomboConfig.get();
        Checkbox cb = Checkbox.builder(Component.literal(""), (Font) this.font).pos(x, y).selected(value)
        ...
        Button orderLabelBtn = Button.builder(Component.literal("§e#" + currentOrder), b -> {
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float partialTick) {
        try {
            ...
            if (selectedCategory == 0 && loreAdditionsX != -1 && mouseX >= loreAdditionsX
            ...
            if (selectedCategory == 0 && frozenBlazeWarnX != -1 && mouseX >= frozenBlazeWarnX
            ...
            switch (selectedCategory) {
                case 0: {
                    ...
                    if (loreAdditionsSubmenu) {
                        ...
                        y1 += 28;
                        y1 = this.drawOptionLabel(g, "§7Copy Canceled Order Amount (Ctrl+Click)", col1X + 24, y1, -1,
                                false);
                        y1 = this.drawOptionLabel(g, "§7Supercraft Max Calculator (Ctrl+Click)", col1X + 24, y1, -1,
                                false);
