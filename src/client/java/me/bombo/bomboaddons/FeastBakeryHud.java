...
public class FeastBakeryHud {
    ...
    public static void drawBakeryInfo(GuiGraphicsExtractor g, int x, int y, List<DetectedItem> items) {
        ...
        // Header
        g.text(font, "§6§lFeast Bakery §r§7- §bScott", 0, 0, 0xFFFFFFFF, true);
        ...
        for (DetectedItem item : items) {
            ...
            g.text(font, nameText, 0, curY, 0xFFFFFFFF, true);
            int valueWidth = font.width(valueText.replaceAll("(?i)§.", ""));
            g.text(font, valueText, width - valueWidth, curY, 0xFFFFFFFF, true);
        ...
        g.text(font, bottomText, (width / 2) - (font.width(bottomText.replaceAll("(?i)§.", "")) / 2), curY + 5, 0xFFFFFFFF, true);
