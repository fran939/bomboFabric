...
public class BomboRenderUtils {
    ...
    public static void drawText(PoseStack poseStack, net.minecraft.client.renderer.OrderedSubmitNodeCollector collector, String text, float x, float y, float z, int color, float scale, boolean shadow, boolean seeThrough) {
