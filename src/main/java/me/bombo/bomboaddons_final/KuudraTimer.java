...
public class KuudraTimer {
    ...
    public static void init() {
        HudRenderCallback.EVENT.register(KuudraTimer::render);
    }
    ...
    public static void drawTimerInfo(GuiGraphics g, int x, int y, boolean forceShow, long remaining, boolean showNow) {
        g.pose().pushMatrix();
