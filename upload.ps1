...
gh release create "v$version" $jarPath --title "v$version" --notes "Bump version to v${version}: full skull/head hitbox, and Coord Bind enhancements (empty coords, radius setting)."
